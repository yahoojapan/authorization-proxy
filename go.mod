...
replace (
	...
	github.com/yahoojapan/athenz-authorizer/v5 => github.com/yahoojapan/athenz-authorizer/v5 v5.4.0
	...
	google.golang.org/genproto => google.golang.org/genproto v0.0.0-20221107162902-2d387536bcdd
